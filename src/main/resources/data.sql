INSERT INTO USUARIO(email, senha, user_name, ativo) VALUES('teste@teste.com', '$2a$10$hdyFo/z9JKdxGafKM2uxNuijgmQXQiu2eC1MFZAQ.lrXPbcy8D10.', 'clienteTeste01','1');

INSERT INTO USUARIO(email, senha, user_name, ativo) VALUES('responsavel@teste.com', '$2a$10$hdyFo/z9JKdxGafKM2uxNuijgmQXQiu2eC1MFZAQ.lrXPbcy8D10.', 'responsavelTeste01','1');

INSERT INTO RESPONSAVEL(nome, nascimento, cpf, cidade, uf, endereco, usuario_id, active) VALUES('Responsavel teste', '2000-10-01', '123445678', 'aracaju', 'SE', 'rua 0', '2','1');
...
INSERT INTO PERFIL(id, nome) VALUES(2, 'ROLE_RESPONSAVEL');
